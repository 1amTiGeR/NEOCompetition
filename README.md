...
3.1 As part of Smart City solution (here we use smart traffic as example) the open data will play key role for SMART solution. for example, you cannot rely on mobile user's subscription to have a whole picture of the traffic situation. data collected from road must be open access to public data and sharing among private and public organisations.

so it make sense to bring public's privacy concern, why city collect my personal information, is it even legal? 

Here we come with blockchain solution. the information collected from road are grouped by different category, the public section will be shared and private section will be protected and granted to authorized organization or individual only.
